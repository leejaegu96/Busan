...
<body>
	<div id="page-wrapper">
		...
		<!-- Main -->
		<section id="main" class="containerMypage">
			<div class="box">
													...
													<tbody id="my_tbody">
														<c:choose>
															<c:when test="${fn:length(list1) eq 0}">
																<tr>
																	<td class="" colspan="6" style="text-align: center;">There is no data!</td>
																</tr>
															</c:when>
															<c:otherwise>
										...
										<form>
											...
											<div class="row mb-3">
												...
												<div class="col-md-8 col-lg-9">
													<label for="Name" class="col-lg-9 col-md-8" style="padding-top: 5px;" name="ifmmName">
														<c:out value="${list.ifmmName }" />
													</label>
												</div>
											</div>
											...
											<div class="row mb-3">
												...
												<div class="col-md-8 col-lg-9">
													<label for="Name" class="col-lg-9 col-md-8" style="padding-top: 5px;">
														<c:out value="${list.ifmmPostNum }" />
														<br> <br>
														<c:out value="${list.ifmmAddress }" />
													</label>
												</div>
											</div>
										</form>
