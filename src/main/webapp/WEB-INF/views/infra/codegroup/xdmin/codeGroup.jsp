															...
															<c:otherwise>
																<c:forEach items="${list}" var="list" varStatus="status">
																	<tr style="cursor: pointer;" onclick="location.href='/codeGroup/codeGroupForm?ifcgSeq=<c:out value="${list.ifcgSeq }"/>'">
																		...
																		<td>
																			<c:out value="${list.IFCG_SEQ }" />
																		</td>
																		<td>
																			<a href="javascript:goForm(<c:out value="${list.ifcgSeq }"/>)" class="text-decoration-none">
																				<c:out value="${list.IFCG_NAME }" />
																			</a>
																		</td>
																		<td>
																			<c:out value="${list.IFCG_ENGNAME }" />
																		</td>
																		<td>
																			<%-- <c:out value="${list.IFCG_count }" /> --%>
																		</td>
																		<td>
																			<fmt:formatDate value="${list.IFCG_REGDATE }" pattern="yyyy-MM-dd HH:mm:ss" />
																		</td>
																		<td>
																			<fmt:formatDate value="${list.IFCG_MODDATE }" pattern="yyyy-MM-dd HH:mm:ss" />
																		</td>
																	</tr>
																</c:forEach>
